...
public class LogementAdapter extends RecyclerView.Adapter<LogementAdapter.ImmobilierViewHolder>{

    private Context context;
    private List<Logement> listLgm;

    public LogementAdapter(Context context, List<Logement> listLgm) {
        ...
        if(listLgm.isEmpty()){
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("idProp", String.valueOf(lgm.getIdProp()));
