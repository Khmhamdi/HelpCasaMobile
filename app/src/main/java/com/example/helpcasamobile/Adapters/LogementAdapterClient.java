...
import com.example.helpcasamobile.Client.DetailsAnnonce;
...
public class LogementAdapterClient extends RecyclerView.Adapter<LogementAdapterClient.ImmobilierViewHolder>{
    private Context context;
    private List<Logement> listLgm;

    public LogementAdapterClient(Context context, List<Logement> listLgm) {
    ...
    @NonNull
    @Override
    public LogementAdapterClient.ImmobilierViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerviewlogment, parent, false);
        return new LogementAdapterClient.ImmobilierViewHolder(view);
    }
        ...
        if(listLgm.isEmpty()){
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, DetailsAnnonce.class);
    ...
    public static class ImmobilierViewHolder extends RecyclerView.ViewHolder{
        TextView tvIdLgm, tvTypLgm, tvTypAnn, tvGouvern, idClient;
        ImageView imvLgm;
