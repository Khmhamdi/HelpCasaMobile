...
import com.example.helpcasamobile.Adapters.LogementAdapterReserve;
...
public class ListImmobiliersReserves extends AppCompatActivity {
    RecyclerView recyclerViewImmobilier;
    RecyclerView.LayoutManager layoutManager;
    LogementAdapterReserve logementAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_list_immobiliers_reserves);

        LogementDataExchange LDE = new LogementDataExchange(this);
        recyclerViewImmobilier = findViewById(R.id.rcvimmores);
        ...
        List<Logement> listLgm = LogementDataExchange.getAllReservedLogements();

        // Check if the list of clients is not empty
        if (!listLgm.isEmpty() && listLgm != null) {
            // Create and set up the adapter
            logementAdapter = new LogementAdapterReserve(this, listLgm);
        ...
        Button rechercher = findViewById(R.id.btnRechLgmRes);

        rechercher.setOnClickListener(new View.OnClickListener() {
            Intent intent;
            @Override
            public void onClick(View v) {
                intent = new Intent(ListImmobiliersReserves.this, RechercheLogement.class);
                startActivity(intent);
            }
        });

        ((ImageView) findViewById(R.id.homeLIR)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListImmobiliersReserves.this, AccueilAgency.class);
                startActivity(intent);
            }
        });
